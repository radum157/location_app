...
class _DeviceListPageState extends State<DeviceListPage> {
  ...
  Future<void> _updateLocation(UserLocation location) async {
    if (location == null || DeviceListPage.id.isEmpty) return;
    try {
      await _devices.doc(DeviceListPage.id).get().then((document) {
            ...
            onPressed: () async {
              if (DeviceListPage.id.isEmpty) {
                ...
                buildSnackBar(context,
                    'Please disconnect the current device before logging out.');
              }
            },
            icon: Icon(
              Icons.logout,
            ...
            children: snapshot.data.docs.map((document) {
              return ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () async {
                    if (document.id == DeviceListPage.id) {
                        DeviceListPage.id = '';
                    }
